  ...
  return (
    <>
      ...
      <div className="px-[12px] md:px-[36px] xl:px-0 mt-[70px] text-center lg:mt-[150px] shadow-sm dark:shadow-slate-100">
        ...
        <div className=" flex items-center justify-center gap-[22px] mb-[40px] md:mb-[70px] pb-4">
          <button type="button">
            <Link
              className="flex items-center z-10 relative transition-all duration-200 group px-[22px] py-[15px] lg:px-[32px] lg:py-[22px] rounded-[50px] bg-teal-600 text-black italic hover:bg-teal-700 hover:text-white dark:bg-gray-700 dark:text-white dark:hover:bg-white dark:hover:text-black dark:text-bold text-heading-6 tracking-wide hover:translate-y-[-2px]"
              to="/faqs"
            >
          ...
          <button type="button">
            {" "}
            <Link
              className="flex items-center z-10 relative transition-all duration-200 group px-[22px] py-[15px] lg:px-[32px] lg:py-[22px] rounded-[50px] italic bg-teal-600 text-black hover:bg-teal-700 dark:hover:bg-white dark:hover:text-black black dark:bg-gray-700 hover:text-white text-heading-6 tracking-wide hover:translate-y-[-2px]"
              to="#"
            >
              <span className="block text-inherit w-full h-full rounded-[50px] text-lg font-chivo font-semibold">
                Learn more
