...
const ServiceCom = ( ) => {
  return (
    <>
      <div className=" px-[12px] md:px-[36px] xl:px-0 mt-[70px] lg:mt-[150px]  ">
        ...
        <div className="container mx-auto grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-x-[30px] gap-y-[50px] mb-[52px] p-14">
